...
if __name__ == "__main__":
    # print(len(load_DOREMIFASOL(10)))

    env = Score_Env(loader.load_test4(20001))  # gym.make("MountainCar-v0")
    print(loader.load_test4(1)[0])
    ...
    sc = music21.converter.parse('test3.mxl')
    rh = sc.parts[0].flat.getElementsByClass("Note")
    test = loader.TEST4
    print(test)
    env_test = Score_Env([test])
    s = (0, 0, 1)
    rh[0].articulations.append(articulations.Fingering(0 + 1))
